...
if __name__ == "__main__":
    ...
    if args.version:
        ...
        proxies = []
        proxy_api = [
            "https://raw.githubusercontent.com/threatcode/free-proxy/master/socks4.txt",
            "https://raw.githubusercontent.com/threatcode/free-proxy/master/socks5.txt",
        ]
        if args.input:
